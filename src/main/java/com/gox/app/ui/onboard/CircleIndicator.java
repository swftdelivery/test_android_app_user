...
public class CircleIndicator extends LinearLayout {
    ...
    private int mIndicatorBackgroundResId = R.drawable.indicator_white;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.indicator_white;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorBackgroundResId = typedArray.getResourceId(R.styleable.CircleIndicator_ci_drawable, R.drawable.indicator_white);
...
//    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.indicator_white : mIndicatorBackgroundResId;
    ...
    private Animator createAnimatorIn(Context context) {
        ...
        } else animatorIn = AnimatorInflater.loadAnimator(context, mAnimatorReverseResId);
        return animatorIn;
    }
...
//            else if (mLastPosition < newCount) mLastPosition = mViewpager.getCurrentItem();
//            else mLastPosition = -1;
//
//            createIndicators();
//        }
//    };
    ...
    private void addIndicator(int orientation,
                              @DrawableRes int backgroundDrawableId,
                              Animator animator) {
