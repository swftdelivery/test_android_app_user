...
public class PolyUtil {
     ...
     */
    private double tanLatGC(double lat1, double lat2, double lng2, double lng3) {
    ...
    public boolean containsLocation(LatLng point, List<LatLng> polygon, boolean geodesic) {
     ...
     */
    public boolean containsLocation(double latitude, double longitude, List<LatLng> polygon, boolean geodesic) {
    ...
    private final double DEFAULT_TOLERANCE = 0.1;  // meters.
     ...
     */
    public boolean isLocationOnEdge(LatLng point, List<LatLng> polygon, boolean geodesic,
                                    double tolerance) {
     ...
     */
    public boolean isLocationOnPath(LatLng point, List<LatLng> polyline,
    ...
    private boolean isLocationOnEdgeOrPath(LatLng point, List<LatLng> poly, boolean closed,
     ...
     */
    public int locationIndexOnPath(LatLng point, List<LatLng> poly,
                                   boolean geodesic, double tolerance) {
     ...
     * with a default tolerance of 0.1 meters.
     */
    public int locationIndexOnPath(LatLng point, List<LatLng> polyline,
                                   boolean geodesic) {
     ...
     * poly.size()-2 if between poly[poly.size() - 2] and poly[poly.size() - 1]
     */
    public int locationIndexOnEdgeOrPath(LatLng point, List<LatLng> poly, boolean closed,
                                         boolean geodesic, double toleranceEarth) {
        int size = poly.size();
        if (size == 0) {
            return -1;
     ...
     */
    private double sinDeltaBearing(double lat1, double lng1,
     ...
     */
    public List<LatLng> simplify(List<LatLng> poly, double tolerance) {
     ...
     * points are the same), and false if it is not
     */
    public boolean isClosedPolygon(List<LatLng> poly) {
     ...
     */
    public double distanceToLine(final LatLng p, final LatLng start, final LatLng end) {
        if (start.equals(end)) {
