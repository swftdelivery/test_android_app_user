...
import com.gox.app.data.repositary.remote.model.StateListResponseData
import com.gox.app.databinding.CountrySearchListItemBinding
...
class StateListAdapter(val activity: FragmentActivity?, val stateList: List<StateListResponseData>)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val inflate = DataBindingUtil.inflate<com.gox.app.databinding.CountrySearchListItemBinding>(LayoutInflater.from(parent.context), R.layout.country_search_list_item, parent, false)
