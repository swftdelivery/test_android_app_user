...
class OrderCouponAdapter(internal var mContext: Context, private var images: ArrayList<PromocodeModel>) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        val itemView = layoutInflater.inflate(R.layout.fragment_order_coupon_selection_page, container, false)
